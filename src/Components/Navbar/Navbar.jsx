    ...
    return (
        <div className='navbar'>
            ...
            <ul className="nav-menu">
                ...
                <li><AnchorLink className='anchor-link' offset={50} href='#porfolio'><p onClick={()=>setMenu("portfolio")}>Portfolio</p></AnchorLink>{menu==="portfolio"? <img src={underline} alt='' />:<></>}</li>
