...
const Hero = () => {
    return (
        <div id='home' className='hero'>
            ...
            <p>Analista e desenvolvedor de sistemas disponível para novas oportunidades. Faça o download do meu currículo e explore esta página web e descubra como posso ajudar no seu projeto.</p>
